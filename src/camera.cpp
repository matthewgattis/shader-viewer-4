...
constexpr float RAD = glm::pi<float>() / 180.0f;
...
void Camera::pan(float x, float y)
{
    view_matrix_ =
        view_matrix_ *
        glm::translate(IDENTITY, PAN_SPEED * distance_ * glm::vec3(-x, y, 0.0f));
}
...
void Camera::update(float frame_delay)
{
    ...
    view_matrix_ = view_matrix_ * glm::translate(IDENTITY, frame_delay * distance_ * velocity_);
}
...
void Camera::handleEvents(const SDL_Event& e, bool enabled, SDL_Window* window)
{
    ...
    switch (e.type)
    {
        ...
        case SDL_EVENT_KEY_UP:
            switch (e.key.key)
            {
                case SDLK_W: acceleration_.z = 0.0f; break;
                case SDLK_S: acceleration_.z = 0.0f; break;
                case SDLK_A: acceleration_.x = 0.0f; break;
                case SDLK_D: acceleration_.x = 0.0f; break;
                case SDLK_SPACE:  acceleration_.y = 0.0f; break;
                case SDLK_LSHIFT: acceleration_.y = 0.0f; break;
            }
            break;
        ...
        case SDL_EVENT_KEY_DOWN:
            switch (e.key.key)
            {
                case SDLK_W: acceleration_.z = -1.0f; break;
                case SDLK_S: acceleration_.z =  1.0f; break;
                case SDLK_A: acceleration_.x = -1.0f; break;
                case SDLK_D: acceleration_.x =  1.0f; break;
                case SDLK_SPACE:  acceleration_.y =  1.0f; break;
                case SDLK_LSHIFT: acceleration_.y = -1.0f; break;
